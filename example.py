...
def main():
    ...
    poly1.plot_polygon(title_legend="Polygon 1", save_path="./output_exmple/polygon1.png")
    ...
    poly2.plot_polygon(plot_vertices=True, title_legend="Polygon 2 after simplification", save_path="./output_exmple/polygon2_simplified.png")
    ...
    result.plot_polygon(title_legend="Union of Polygon 1 and 2", save_path="./output_exmple/union_polygon1_polygon2.png")
    ...
    print(f"Resulting Polygon area: {result.get_area()}, perimeter: {result.get_perimeter()}")
    result_int.plot_polygon(title_legend="Intersection of Polygon 1 and 2", save_path="./output_exmple/intersection_polygon1_polygon2.png")
    ...
    poly3.unify_polygons(result_int).plot_polygon(title_legend="Union of Polygon 3 and Intersection of Polygon 1 and 2 (comp 1)", save_path="./output_exmple/union_polygon3_intersection_polygon1_polygon2.png")
